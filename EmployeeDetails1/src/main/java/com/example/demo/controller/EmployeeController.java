...
//	
	...
	//jPQL Queries
	@Transactional
	@PutMapping("/updateEmployeeSalary/{sal}/{id}")
	public String updateEmployeeSalary(@PathVariable double sal,@PathVariable long id ) {
//		String res="";
		int result = service.updateEmployeeSalary(sal,id);
		if(result>0) {
			return  "Salary Updated"+result;
//			System.err.println(res);
		}
		else {
			return  "Not Updated"+result;
//			System.err.println(res);
		}
//		return "Done";
	}
